...
\ifcastellano\usepackage[catalan,spanish,es-tabla]{babel}\fi
...
\usepackage[
	url = true,
	style = apa, % https://biblioguias.webs.upv.es/bg/index.php/es/normas-y-estilos
	%style = ieee,
	hyperref = true,
	backref = true,
...
\centering
\fbox{%
\begin{minipage}[c][0.30\textheight][c]{0.82\textwidth}
\centering
\textbf{Imagen pendiente}\par\medskip
#1
\end{minipage}}
\caption{#2}
\label{#3}
